...
def upgrade() -> None:
    ...
    sa.ForeignKeyConstraint(['user_id'], ['users.id'], name=op.f('synthetic_user_attributes_user_id_fkey')),
    ...
    op.create_foreign_key(op.f('users_backfill_job_id_fkey'), 'users', 'synthetic_backfill_attributes', ['backfill_job_id'], ['id'])
    # ### end Alembic commands ###


def downgrade() -> None:
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_constraint(op.f('users_backfill_job_id_fkey'), 'users', type_='foreignkey')
