...
from ypl.backend.llm.review_types import BinaryResult, CritiqueResult, ReviewStatus, ReviewType, SegmentedResult
...
class MessageReview(BaseModel, table=True):
    ...
    result: BinaryResult | CritiqueResult | SegmentedResult = Field(sa_type=JSONB)
