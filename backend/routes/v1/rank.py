...
from backend.llm.ranking import RANKER_TYPES, AnnotatedFloat, RankedModel, get_per_category_rankers
...
def model_rank(
    ...
    return get_per_category_rankers(ranker_type).rank_annotate_all_categories(model_name)
