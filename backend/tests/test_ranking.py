...
def test_naive_ranker() -> None:
    ...
    assert ranker.predict("a", "b") == AnnotatedFloat(
...
def test_elo_ranker() -> None:
    ...
    _assert_approx(
        ranker.predict("a", "b"), 0.517, "rating_a=1005.93, rating_b=994.07"
    )
    ...
    _assert_approx(
        ranker.predict("a", "b"), 0.505, "rating_a=1001.82, rating_b=998.18"
    )
    ...
    _assert_approx(
        ranker.predict("a", "b"), 0.023, "rating_a=672.68, rating_b=1327.32"
    )
